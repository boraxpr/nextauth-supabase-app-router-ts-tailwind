      ...
      <div className="">
        <div className="py-1 lg:px-72 space-y-5">
          <div className="flex justify-between items-center">
            <div className="w-7/12 print:w-11/12 mx-5 p-4 m-2 bg-#000000 shadow-md rounded-md border"></div>
          ...
          <div className="flex justify-between items-center">
            <div className="w-7/12 print:w-11/12 mx-5 p-4 m-2 bg-white shadow-md rounded-md border"></div>
            <div className="w-5/12 print:w-11/12 mx-5 p-10 bg-white shadow-md rounded-md border">
